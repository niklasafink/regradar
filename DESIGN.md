...
Deutsch ist Leitsprache, Englisch vollständig gepflegt (Umschalter in der Navigation). Dokumenttitel und Normbezeichnungen bleiben in Originalsprache. Ausnahme: kryptische Titel (reine Regel-IDs, Aktenzeichen, Codes wie „Validation Rule RRCOROF_V903610_H_C0030") ersetzt der Scraper durch einen beschreibenden, zielgruppengerechten Anzeigetitel mit offiziellen Fachbegriffen; die offizielle Kennung bleibt in Klammern erhalten (Auffindbarkeit), die URL bleibt am Original-Titel verankert. Datumsformat 24.08.2026 im Deutschen, 24 Aug 2026 im Englischen.
