...
export const FRAMEWORKS: Framework[] = [
  ...
  { id:"crr3", jur:"EU",
    about:{de:"Umsetzung von Basel III in der EU: Eigenmittelanforderungen, Output Floor, Kreditrisiko-Standardansatz und Marktrisiko. Die CRD VI ist in Deutschland seit 31.03.2026 durch das BRUBEG im KWG umgesetzt.",en:"EU implementation of Basel III: own funds requirements, output floor, standardised credit risk approach and market risk. In Germany, CRD VI has been transposed into the KWG by the BRUBEG since 31 March 2026."}, topic:"PRU", ents:["CI"],
    n:{de:"CRR III / CRD VI: Eigenmittel und Aufsicht",en:"CRR III / CRD VI: capital and supervision"},
    alias:"Basel III, Basel IV, Bankenpaket, Banking Package, Capital Requirements Regulation, KWG, Eigenkapital, LCR, NSFR, Leverage Ratio, SREP, ICAAP, BRUBEG, Bankenrichtlinienumsetzungs- und Bürokratieentlastungsgesetz, CRD VI, Bankenrichtlinie, Organkredite, § 18 KWG, Risikoreduzierungsgesetz, RiG, CRD V, CRD-IV-Umsetzungsgesetz",
    ref:"VO (EU) 2024/1623, RL (EU) 2024/1619", cond:null,
    refUrl:"https://eur-lex.europa.eu/eli/reg/2024/1623/oj/eng",
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 06.09.2026; BRUBEG-Verlauf gegen DIP, bundestag.de, recht.bund.de, bafin.de, bundesbank.de und gesetze-im-internet.de geprüft). */
    u:[
      {d:"22.04.2026", t:{de:"Bericht",en:"Report"}, src:"bundesbank.de",
       url:"https://publikationen.bundesbank.de/publikationen-de/berichte-studien/monatsberichte/monatsbericht-april-2026-990912?article=das-bankenrichtlinienumsetzungs-und-buerokratieentlastungsgesetz-brubeg--990918",
       ti:{de:"Bundesbank-Monatsbericht erläutert das BRUBEG: Entlastungen, Drittstaatenzweigstellen, ESG-Risikopläne",en:"Bundesbank monthly report explains the BRUBEG: relief measures, third-country branches, ESG risk plans"},
       s:{de:"Der Aufsatz im Monatsbericht April 2026 ordnet das Gesetz ein: Kreditwürdigkeitsprüfung nach § 18 KWG erst ab 1,5 Mio. € statt 750.000 €, Bagatellgrenze von 100.000 € statt 50.000 € für Organkredite und Ausnahme für automatisierte Kreditentscheidungen bis 20.000 €, Anzeigepflichten für Beteiligungserwerbe und Fusionen, periodische Zwangsgelder bis 50.000 € täglich bzw. 5 % des Nettotagesumsatzes, zwei Risikoklassen für CRD-Drittstaatenzweigstellen mit Mindestkapital (Klasse 1: 2,5 % der durchschnittlichen Verbindlichkeiten, mindestens 10 Mio. €) sowie ESG-Risikopläne, die kleine Institute erst ab 11.01.2027 und mit Erleichterungen aufstellen müssen. Derselbe Monatsbericht enthält den Aufsatz „Nachhaltigkeitsrisiken in der Bankenaufsicht“.",
          en:"The article in the April 2026 monthly report puts the act into context: creditworthiness checks under § 18 KWG only from €1.5 million instead of €750,000, a €100,000 instead of €50,000 de minimis threshold for loans to board members and an exemption for automated credit decisions up to €20,000, notification duties for acquisitions of holdings and mergers, periodic penalty payments of up to €50,000 per day or 5 % of average daily net turnover, two risk classes for CRD third-country branches with minimum capital (class 1: 2.5 % of average liabilities, at least €10 million) and ESG risk plans, which small institutions only have to draw up from 11 January 2027 and with relief. The same monthly report contains the article “Sustainability risks in banking supervision”."}},
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       ...
       s:{de:"Das Bankenrichtlinienumsetzungs- und Bürokratieentlastungsgesetz vom 25.03.2026 (Bundestag 29.01.2026, Bundesrat 06.03.2026) setzt die CRD VI um: eigenständiges Erlaubnis- und Aufsichtsregime für CRD-Drittstaatenzweigstellen (§§ 53c ff. KWG), Fit-&-Proper-Regime für Inhaber von Schlüsselfunktionen (§ 25e KWG), ESG-Risikoplan (§ 26d KWG), erweiterte Eingriffs- und Sanktionsbefugnisse der BaFin sowie Entlastungen bei § 18 KWG, Organkrediten und Anzeigen. Es ändert daneben AnzV, SolvV, GroMiKV, InstitutsVergV, PrüfbV, SAG, FinDAG, ZAG, WpIG, KAGB, PfandBG und VAG. In Kraft seit 31.03.2026, einzelne Artikel seit 01.04.2026 und 01.07.2026; das Drittstaatenregime gilt ab 11.01.2027.",
          en:"The Banking Directive Implementation and Bureaucracy Relief Act of 25 March 2026 (Bundestag 29 January 2026, Bundesrat 6 March 2026) transposes CRD VI: a standalone licensing and supervisory regime for CRD third-country branches (sections 53c et seq. KWG), a fit-and-proper regime for key function holders (section 25e KWG), an ESG risk plan (section 26d KWG), extended BaFin intervention and sanctioning powers, plus relief on section 18 KWG, loans to board members and notifications. It also amends the AnzV, SolvV, GroMiKV, InstitutsVergV, PrüfbV, SAG, FinDAG, ZAG, WpIG, KAGB, PfandBG and VAG. In force since 31 March 2026, individual articles since 1 April and 1 July 2026; the third-country regime applies from 11 January 2027."}},
      {refnum:"BT-Drs. 21/3897", d:"29.01.2026", t:{de:"Gesetz",en:"Act"}, src:"bundestag.de",
       url:"https://www.bundestag.de/dokumente/textarchiv/2026/kw05-de-brubeg-1136940",
       ti:{de:"Bundestag beschließt BRUBEG: CRD-VI-Umsetzung mit Entlastungen für kleine Banken",en:"Bundestag adopts the BRUBEG: CRD VI transposition with relief for small banks"},
       s:{de:"Der Bundestag nahm den Regierungsentwurf (BT-Drs. 21/3058) in der Fassung des Finanzausschusses mit den Stimmen von CDU/CSU, SPD und Grünen an. Gegenüber dem Entwurf wurden die ESG-Pflichten kleiner, nicht komplexer Institute auf qualitative Risikopläne reduziert, Förderbanken von ESG-Berichtspflichten ausgenommen, automatisierte Kreditentscheidungen bis 20.000 € von den Organkreditvorschriften befreit und die Strategieüberprüfung kleiner Institute auf alle zwei Jahre gestreckt; die jährliche Entlastung wird mit rund 89 Mio. € beziffert. Der Bundesrat rief am 06.03.2026 den Vermittlungsausschuss nicht an.",
          en:"The Bundestag adopted the government bill (BT-Drs. 21/3058) as amended by the Finance Committee with the votes of CDU/CSU, SPD and the Greens. Compared with the draft, ESG duties of small and non-complex institutions were reduced to qualitative risk plans, development banks were exempted from ESG reporting, automated credit decisions up to €20,000 were freed from the rules on loans to board members and the strategy review of small institutions was stretched to every two years; the annual relief is put at around €89 million. On 6 March 2026 the Bundesrat did not refer the act to the mediation committee."}},
      {refnum:"BT-Drs. 21/3058", d:"12.01.2026", t:{de:"Anhörung",en:"Hearing"}, src:"bundestag.de",
       url:"https://www.bundestag.de/ausschuesse/a07_finanzen/wp21_a07_Anhoerungen/1133892-1133892",
       ti:{de:"Finanzausschuss hört Sachverständige zum BRUBEG: Streit um ESG-Pflichten kleiner Institute",en:"Finance Committee hears experts on the BRUBEG: dispute over ESG duties of small institutions"},
       s:{de:"In der öffentlichen Anhörung zum Regierungsentwurf (BT-Drs. 21/3058) stritten BVR, DSGV, Bankenverband, VÖB, vdp, BaFin und Finance Watch vor allem über den Umgang mit ESG-Risiken: Die Kreditwirtschaft warnte vor hohem Aufwand und Doppelregulierung bei kleinen und mittleren Instituten und forderte Ausnahmen für Förderbanken, Finance Watch mahnte die Berücksichtigung langfristiger Klimarisiken an. Mehrere Proportionalitätsforderungen übernahm der Finanzausschuss später in seine Beschlussempfehlung.",
          en:"At the public hearing on the government bill (BT-Drs. 21/3058), the BVR, DSGV, Bankenverband, VÖB, vdp, BaFin and Finance Watch argued mainly about the treatment of ESG risks: the banking industry warned of high costs and double regulation for small and medium-sized institutions and called for exemptions for development banks, while Finance Watch urged that long-term climate risks be taken into account. The Finance Committee later adopted several proportionality demands in its recommendation."}},
      {d:"11.12.2025", t:{de:"Mitteilung",en:"Statement"}, src:"bundesbank.de",
       url:"https://www.bundesbank.de/de/service/termine/brubeg-und-die-umsetzung-der-crd-vi-963048",
       ti:{de:"Digitales Aufsichtsbriefing von BaFin und Bundesbank zum BRUBEG und zur CRD-VI-Umsetzung",en:"Digital supervisory briefing by BaFin and the Bundesbank on the BRUBEG and CRD VI transposition"},
       s:{de:"Noch während des parlamentarischen Verfahrens erläuterten BaFin und Bundesbank im virtuellen Aufsichtsbriefing den Gesetzentwurf: Umsetzung der CRD-VI-Vorgaben zu Governance, ESG-Risiken, Drittstaatenzweigstellen und Sanktionen sowie die geplanten Entlastungen für Kreditinstitute, mit Fragerunde. Die Präsentation ist auf der Veranstaltungsseite abrufbar.",
          en:"While the parliamentary procedure was still under way, BaFin and the Bundesbank explained the bill in a virtual supervisory briefing: transposition of the CRD VI requirements on governance, ESG risks, third-country branches and sanctions as well as the planned relief for credit institutions, with a Q&A session. The presentation is available on the event page."}},
      {refnum:"BR-Drs. 552/25", d:"10.10.2025", t:{de:"Gesetzentwurf",en:"Bill"}, src:"bundesfinanzministerium.de",
       url:"https://www.bundesfinanzministerium.de/Content/DE/Gesetzestexte/Gesetze_Gesetzesvorhaben/Abteilungen/Abteilung_VII/21_Legislaturperiode/2025-10-10-BRUBEG/0-Gesetz.html",
       ti:{de:"Regierungsentwurf des BRUBEG dem Bundesrat zugeleitet",en:"Government draft of the BRUBEG submitted to the Bundesrat"},
       s:{de:"Der Regierungsentwurf setzt die Richtlinie (EU) 2024/1619 im KWG um und bündelt Entlastungen: höhere Schwelle für die Kreditwürdigkeitsprüfung nach § 18 KWG, vereinfachte Organkreditregeln und gestraffte Anzeigepflichten; der Nationale Normenkontrollrat beziffert die jährliche Entlastung auf rund 89 Mio. € bei einmaligem Erfüllungsaufwand von rund 28 Mio. €. Der Bundesrat nahm am 21.11.2025 Stellung und forderte weitere Proportionalitätsmaßnahmen für kleine Institute; der Entwurf ging am 03.12.2025 als BT-Drs. 21/3058 in den Bundestag, erste Lesung am 19.12.2025.",
          en:"The government draft transposes Directive (EU) 2024/1619 into the KWG and bundles relief measures: a higher threshold for creditworthiness checks under section 18 KWG, simplified rules on loans to board members and streamlined notification duties; the National Regulatory Control Council puts the annual relief at around €89 million with one-off compliance costs of around €28 million. The Bundesrat commented on 21 November 2025 and called for further proportionality measures for small institutions; the draft reached the Bundestag on 3 December 2025 as BT-Drs. 21/3058, first reading on 19 December 2025."}},
      {d:"22.08.2025", t:{de:"Gesetzentwurf",en:"Bill"}, src:"bundesfinanzministerium.de",
       url:"https://www.bundesfinanzministerium.de/Content/DE/Gesetzestexte/Gesetze_Gesetzesvorhaben/Abteilungen/Abteilung_VII/21_Legislaturperiode/2025-10-10-BRUBEG/0-Gesetz.html",
       ti:{de:"BMF legt Referentenentwurf zur Umsetzung der CRD VI vor (BRUBEG)",en:"Finance ministry publishes draft bill transposing CRD VI (BRUBEG)"},
       s:{de:"Der Referentenentwurf vom 22.08.2025 sieht die Umsetzung der CRD VI im KWG vor: Aufsichtsbefugnisse, Sanktionen, Zweigstellen aus Drittländern und ESG-Risiken, verbunden mit Bürokratieabbau zugunsten kleiner Institute und mittelständischer Kreditnehmer. 23 Verbände und Institutionen nahmen Stellung.",
          en:"The ministry draft of 22 August 2025 provides for transposing CRD VI into the KWG: supervisory powers, sanctions, third-country branches and ESG risks, combined with red-tape reduction for small institutions and SME borrowers. 23 associations and institutions submitted comments."}},
      ...
      {refnum:"BGBl. 2020 I S. 2773", d:"14.12.2020", eff:"28.12.2020", t:{de:"Gesetz",en:"Act"}, src:"bgbl.de",
       url:"https://www.bgbl.de/xaver/bgbl/start.xav?startbk=Bundesanzeiger_BGBl&jumpTo=bgbl120s2773.pdf",
       ti:{de:"Risikoreduzierungsgesetz: CRD V und BRRD II im KWG und SAG umgesetzt",en:"Risk Reduction Act: CRD V and BRRD II transposed into the KWG and SAG"},
       s:{de:"Der Vorgänger des BRUBEG setzt das EU-Bankenpaket 2019 um: Zulassungspflicht für Finanzholding-Gesellschaften (§ 2f KWG), Kapitalpuffer für die Verschuldungsquote global systemrelevanter Institute, mehr Proportionalität für kleine, nicht komplexe Institute, Identifizierung von Risikoträgern im KWG und angepasste Sanktionen; im SAG werden MREL und die Abwicklungsvorgaben der BRRD II nachgezogen. Gesetz vom 09.12.2020, verkündet in BGBl. 2020 I Nr. 61, in Kraft überwiegend seit 28.12.2020.",
          en:"The predecessor of the BRUBEG transposes the 2019 EU banking package: approval requirement for financial holding companies (section 2f KWG), leverage ratio buffer for global systemically important institutions, more proportionality for small and non-complex institutions, identification of material risk takers in the KWG and adjusted sanctions; in the SAG, MREL and the BRRD II resolution requirements are updated. Act of 9 December 2020, promulgated in BGBl. 2020 I No. 61, largely in force since 28 December 2020."}},
      ...
      {refnum:"BGBl. 2013 I S. 3395", d:"03.09.2013", eff:"01.01.2014", t:{de:"Gesetz",en:"Act"}, src:"bgbl.de",
       url:"https://www.bgbl.de/xaver/bgbl/start.xav?startbk=Bundesanzeiger_BGBl&jumpTo=bgbl113s3395.pdf",
       ti:{de:"CRD-IV-Umsetzungsgesetz: KWG an CRR und CRD IV angepasst",en:"CRD IV Implementation Act: KWG aligned with the CRR and CRD IV"},
       s:{de:"Das Gesetz vom 28.08.2013 passt das KWG an die unmittelbar geltende CRR an und setzt die CRD IV um: neuer Begriff des CRR-Kreditinstituts (§ 1 Abs. 3d KWG), Kapitalpuffer (§§ 10c bis 10i KWG), verschärfte Anforderungen an Geschäftsleiter und Aufsichtsorgane mit Mandatsobergrenzen (§§ 25c, 25d KWG), Vergütungsregeln und ein erweiterter Bußgeldkatalog. Verkündet in BGBl. 2013 I Nr. 53, in Kraft seit 01.01.2014; Übergangsvorschriften in § 64r KWG.",
          en:"The act of 28 August 2013 aligns the KWG with the directly applicable CRR and transposes CRD IV: new concept of the CRR credit institution (section 1(3d) KWG), capital buffers (sections 10c to 10i KWG), stricter requirements for managing directors and supervisory bodies with limits on mandates (sections 25c, 25d KWG), remuneration rules and an extended catalogue of fines. Promulgated in BGBl. 2013 I No. 53, in force since 1 January 2014; transitional provisions in section 64r KWG."}},
  ...
  { id:"ebatcb", jur:"EU", parent:"crr3",
    about:{de:"Informationen, Prüfkriterien, Formulare und Verfahren für die Zulassung von Zweigstellen von Drittlandkreditinstituten im neuen CRD-VI-Regime, das ab 11.01.2027 gilt; in Deutschland umgesetzt durch das BRUBEG in den §§ 53c ff. KWG.",
           en:"Information requirements, assessment criteria, templates and procedures for authorising branches of third-country credit institutions under the new CRD VI regime applying from 11 January 2027; transposed in Germany by the BRUBEG in sections 53c et seq. KWG."},
    topic:"PRU", ents:["CI"],
    ...
    alias:"Third-Country Branches, TCB, Drittlandzweigstelle, Drittstaatenzweigstelle, CRD-Drittstaatenzweigstelle, CRD VI, EBA/GL/2026/08, Art. 48c CRD, BRUBEG, §§ 53c ff. KWG, § 53ci KWG",
    ...
    u:[
      ...
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"11.01.2027", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"BRUBEG: Erlaubnispflicht und Risikoklassen für CRD-Drittstaatenzweigstellen im KWG (§§ 53c ff.)",en:"BRUBEG: licensing requirement and risk classes for CRD third-country branches in the KWG (sections 53c et seq.)"},
       s:{de:"Zweigstellen von Instituten aus Drittstaaten, die in Deutschland Einlagen-, Kredit- oder Garantiegeschäft betreiben, brauchen eine eigene Erlaubnis. Klasse 1 (Bilanzsumme ab 5 Mrd. €, wesentliches Einlagengeschäft oder nicht klein und nicht komplex) muss Kapital von 2,5 % der durchschnittlichen Verbindlichkeiten, mindestens 10 Mio. €, gesondert vorhalten; Klasse 2 erhält Erleichterungen bei Kapital, Liquidität und Meldungen. Ab 10 Mrd. € Zweigstellenaktiva oder 40 Mrd. € in der EU kann die BaFin eine Tochtergesellschaft verlangen (§ 53ci KWG). Die §§ 53c bis 53cq gelten ab 11.01.2027, die Meldepflichten an die Bundesbank (§§ 53ck, 53cl KWG) bereits jetzt (§ 64c Abs. 5 KWG). Bis 10.01.2027 erteilte Erlaubnisse gelten nur fort, wenn die BaFin dies beschließt und die Zweigstelle die neuen Anforderungen erfüllt (§ 53cc Abs. 6 KWG); bestehende Zweigstellen werden dafür aufsichtlich überprüft, Fragen zum Markteintritt beantwortet die BaFin unter licensingTCB@bafin.de.",
          en:"Branches of third-country institutions conducting deposit, lending or guarantee business in Germany need their own licence. Class 1 (total assets from €5 billion, material deposit business or not small and non-complex) must hold capital of 2.5 % of average liabilities, at least €10 million, in segregated form; class 2 benefits from relief on capital, liquidity and reporting. From €10 billion of branch assets or €40 billion across the EU, BaFin may require a subsidiary (section 53ci KWG). Sections 53c to 53cq apply from 11 January 2027, the reporting duties towards the Bundesbank (sections 53ck, 53cl KWG) already now (section 64c(5) KWG). Licences granted up to 10 January 2027 continue only if BaFin so decides and the branch meets the new requirements (section 53cc(6) KWG); existing branches undergo a supervisory review for this purpose, and BaFin answers market-entry questions at licensingTCB@bafin.de."}},
  ...
  { id:"marisk", jur:"DE",
    ...
    u:[
      {refnum:"RS 06/2026 (BA)", eff:"01.01.2027", d:"30.06.2026", t:{de:"Rundschreiben",en:"Circular"}, src:"bafin.de",
       ...
       s:{de:"BaFin und Bundesbank haben die MaRisk grundlegend überarbeitet und deutlich verschlankt. Öffnungsklauseln für kleine und sehr kleine Institute wurden erweitert, die Proportionalitätsstufen an eine transparente Einordnung geknüpft. Umgesetzt werden zudem die EBA-Leitlinien zur Umweltszenarioanalyse (EBA/GL/2025/04) und zur internen Governance. Neu ist das Modul AT 4.3.4 „Verwendung von Modellen“, das ausdrücklich auch für automatisierte Modelle und künstliche Intelligenz gilt: Eignungsprüfung vor dem Einsatz, Datenqualität, Regeln für Überschreibungen, regelmäßige Validierung und Erklärbarkeit der Wirkungszusammenhänge zwischen Ein- und Ausgangsgrößen – etwa bei Scoring-, Risikoklassifizierungs-, Stresstest- und Bewertungsmodellen. Neue und verschärfte Anforderungen sind bis zum 01.01.2027 umzusetzen, Erleichterungen gelten sofort.",
          en:"BaFin and the Bundesbank have fundamentally revised and streamlined the MaRisk. Opening clauses for small and very small institutions were extended and the proportionality tiers tied to a transparent classification. The amendment also implements the EBA guidelines on environmental scenario analysis (EBA/GL/2025/04) and on internal governance. A new module AT 4.3.4 'Use of models' explicitly also covers automated models and artificial intelligence: suitability assessment before use, data quality, rules on overrides, regular validation and explainability of the relationships between inputs and outputs – for example in scoring, risk classification, stress testing and valuation models. New and stricter requirements must be implemented by 1 January 2027; relief measures apply immediately."}},
  ...
  { id:"instvergv", jur:"DE",
    ...
    alias:"InstitutsVergV, IVV, InstitutsVergV 5.0, IVV 5.0, BRUBEG, Vergütung Banken, Vergütungsverordnung, Risikoträger, Material Risk Taker, WpI-VergV, Bonus",
    ...
    u:[
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"InstitutsVergV 5.0: BRUBEG passt die Vergütungsverordnung an die CRD VI an",en:"InstitutsVergV 5.0: BRUBEG aligns the remuneration ordinance with CRD VI"},
       s:{de:"Die Artikel 11 und 12 des BRUBEG ändern die InstitutsVergV: ESG-Risiken sind in Vergütungsstrategie und variabler Vergütung zu berücksichtigen, das Aufsichtsorgan wird stärker in die Identifizierung der Risikoträger eingebunden, identifizierte Risikoträger sind zeitnah zu informieren und Drittstaatenzweigstellen erhalten eigene Vorgaben; Verstöße gegen Vergütungsvorgaben sind neu bußgeldbewehrt (§ 56 KWG). Wesentliche Teile gelten seit 31.03.2026, Artikel 12 seit 01.04.2026.",
          en:"Articles 11 and 12 of the BRUBEG amend the InstitutsVergV: ESG risks must be reflected in the remuneration strategy and in variable pay, the supervisory body is more closely involved in identifying material risk takers, identified risk takers must be informed promptly and third-country branches receive their own requirements; breaches of remuneration rules are now subject to fines (section 56 KWG). Main parts apply since 31 March 2026, article 12 since 1 April 2026."}},
  ...
  { id:"zag", jur:"DE",
    ...
    alias:"ZAG, Zahlungsdiensteaufsichtsgesetz, Zahlungsinstitute, E-Geld-Institute, ZAG-Erlaubnis, Finanztransfergeschäft, Kontoinformationsdienst, BRUBEG",
    ...
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 06.09.2026; BRUBEG-Artikel 17 gegen buzer.de geprüft). */
    u:[
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"BRUBEG erweitert die Prüfungs- und Durchsuchungsbefugnisse der BaFin im ZAG",en:"BRUBEG extends BaFin's audit and search powers under the ZAG"},
       s:{de:"Artikel 17 des Bankenrichtlinienumsetzungs- und Bürokratieentlastungsgesetzes überträgt die neuen KWG-Eingriffsbefugnisse auf Zahlungs- und E-Geld-Institute: Auskunfts- und Vorlagepflichten treffen auch Agenten, E-Geld-Agenten, Auslagerungsunternehmen und ausgeschiedene Organmitglieder, die BaFin darf Räume bei dringender Gefahr auch außerhalb der Geschäftszeiten betreten und mit richterlicher Anordnung durchsuchen und Beweismittel sicherstellen (§ 19 ZAG); die Prüfungsrechte gelten entsprechend § 44b KWG auch gegenüber Inhabern bedeutender Beteiligungen (§ 14 ZAG), und der von der BaFin bestellte Abwickler kann selbst Insolvenzantrag stellen (§ 7 ZAG).",
          en:"Article 17 of the Banking Directive Implementation and Bureaucracy Relief Act extends the new KWG intervention powers to payment and e-money institutions: information and disclosure duties also apply to agents, e-money agents, outsourcing providers and former board members, BaFin may enter premises outside business hours in case of imminent danger and, with a court order, search them and seize evidence (section 19 ZAG); the audit rights apply, in line with section 44b KWG, to holders of significant participations as well (section 14 ZAG), and the liquidator appointed by BaFin may file for insolvency itself (section 7 ZAG)."}},
  ...
  { id:"dsgvo", jur:"EU+DE",
    ...
    alias:"DSGVO, GDPR, General Data Protection Regulation, Datenschutz-Grundverordnung, BDSG, Datenschutz, Privacy, Auftragsverarbeitung, Datenpanne, Data Breach, Cookies, Einwilligung, DSFA, DPIA, Scoring, § 37a BDSG, § 31 BDSG, Credit Scoring, automatisierte Entscheidung, Art. 22 DSGVO, SCHUFA-Urteil, Pseudonymisierung, Datenomnibus",
    ref:"VO (EU) 2016/679, BDSG", cond:null,
    refUrl:"https://eur-lex.europa.eu/eli/reg/2016/679/oj/eng",
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 03.09.2026). */
    /* 20.09.2026: § 37a BDSG ergänzt (Regelungstext BGBl. 2026 I Nr. 139 geprüft).
       Urteile und Aufsichtsstellungnahmen bekommen bewusst keinen eigenen Chronologie-Eintrag;
       ihre Folgen stehen dort, wo für das Institut eine Pflicht entsteht. */
    u:[
      {refnum:"BGBl. 2026 I Nr. 139", eff:"20.11.2026", d:"18.05.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/eli/bund/bgbl-1/2026/139",
       ti:{de:"Neue gesetzliche Regeln für Scoring und automatisierte Entscheidungen ab 20.11.2026",en:"New statutory rules on scoring and automated decisions from 20 November 2026"},
       s:{de:"Das Gesetz zur Umsetzung der Verbraucherkreditrichtlinie (CCD II) stellt Scoring erstmals auf eine eigene gesetzliche Grundlage und löst die bisherige Auskunfteien-Regelung ab. Erfasst sind nicht nur Auskunfteien, sondern auch das interne Scoring der Institute für Vertragsentscheidungen.\n\nBestimmte Datenarten dürfen für Scores nicht mehr genutzt werden, darunter Kontobewegungen und Anschriftendaten; für die Kreditwürdigkeitsprüfung im Verbraucherkreditrecht bleiben Kontodaten nutzbar. Hinzu kommen Nachweis- und Transparenzanforderungen sowie das Recht der Kunden, eine automatisierte Entscheidung durch einen Menschen überprüfen zu lassen. Die Regeln gelten ab 20.11.2026 gemeinsam mit den verschärften Vorgaben zur Kreditwürdigkeitsprüfung.",
          en:"The act transposing the Consumer Credit Directive (CCD II) puts scoring on its own statutory footing for the first time and replaces the previous credit bureau rule. It covers not only credit bureaus but also institutions' internal scoring for contract decisions.\n\nCertain types of data may no longer be used for scores, including account movements and address data; account data remain usable for the creditworthiness assessment under consumer credit law. Evidence and transparency requirements are added, as is customers' right to have an automated decision reviewed by a human. The rules apply from 20 November 2026 together with the stricter creditworthiness assessment requirements."}},
      {refnum:"COM(2025) 837", d:"19.11.2025", t:{de:"Kommissionsvorschlag",en:"Commission proposal"}, src:"eur-lex.europa.eu",
       ...
       s:{de:"Der Vorschlag COM(2025) 837 ändert DSGVO, Data Act und NIS 2: präzisierte Definition personenbezogener Daten, Rechtsgrundlage für KI-Training als berechtigtes Interesse, zentrale Meldestelle für Datenpannen, Cookie-Einwilligung über Browser-Einstellungen und Entlastungen für kleine und mittlere Unternehmen. Der Vorschlag ist noch nicht beschlossen: Europäischer Datenschutzausschuss und Europäischer Datenschutzbeauftragter haben die Neufassung des Personenbezugs in ihrer gemeinsamen Stellungnahme 2/2026 vom 11.02.2026 abgelehnt, der Trilog hat noch nicht begonnen. Für laufende Projekte bleibt damit die geltende Rechtslage maßgeblich.",
          en:"Proposal COM(2025) 837 amends the GDPR, Data Act and NIS 2: a clarified definition of personal data, legitimate interest as a legal basis for AI training, a single entry point for breach notifications, cookie consent via browser settings and relief for small and mid-sized companies. The proposal has not been adopted: the European Data Protection Board and the European Data Protection Supervisor rejected the redefinition of personal data in their joint opinion 2/2026 of 11 February 2026, and the trilogue has not started. Current law therefore remains decisive for ongoing projects."}},
      {refnum:"BGBl. 2017 I S. 2097", eff:"25.05.2018", d:"30.06.2017", t:{de:"Gesetz",en:"Act"}, src:"gesetze-im-internet.de",
       ...
       s:{de:"Das BDSG 2018 nutzt die Öffnungsklauseln der DSGVO, u. a. zu Datenschutzbeauftragten, Beschäftigtendatenschutz, Scoring und Bonitätsauskünften (2026 neu geregelt) und Videoüberwachung, und setzt die JI-Richtlinie um. Anwendung ab 25.05.2018.",
          en:"The BDSG 2018 uses the GDPR opening clauses, including on data protection officers, employee data, scoring and credit reports (section 31, replaced by section 37a from 20 November 2026) and video surveillance, and implements the Law Enforcement Directive. Applicable from 25 May 2018."}},
  ...
  { id:"aiact", jur:"EU",
    ...
    alias:"EU AI Act, AI Act, KI-VO, KI-Gesetz, AI Regulation, Artificial Intelligence Act, KI-Verordnung, künstliche Intelligenz, GPAI, Hochrisiko-KI, High-Risk AI, AI Office, KI-Omnibus, Digital-Omnibus, VO (EU) 2026/1744, KI-MIG, KI-Durchführungsgesetz, KI-Marktüberwachung, Art. 50, Transparenzkodex, KI-Kompetenz",
    ref:"VO (EU) 2024/1689", cond:null,
    refUrl:"https://eur-lex.europa.eu/eli/reg/2024/1689/oj/eng",
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 03.09.2026). */
    /* 20.09.2026: Verhaltenskodex Art. 50, Entwurf Hochrisiko-Leitlinien sowie Leitlinien 2025 ergänzt (digital-strategy.ec.europa.eu geprüft).
       KI-Omnibus VO (EU) 2026/1744, KI-Durchführungsgesetz (BGBl. 2026 I Nr. 223) und Art.-50-Leitlinien kommen über live.json. */
    u:[
      {d:"10.06.2026", eff:"02.08.2026", t:{de:"Verhaltenskodex",en:"Code of practice"}, src:"digital-strategy.ec.europa.eu", imp:"medium",
       url:"https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content",
       ti:{de:"Verhaltenskodex zur Transparenz KI-generierter Inhalte veröffentlicht (Art. 50 KI-VO)",en:"Code of Practice on Transparency of AI-generated Content published (Art. 50 AI Act)"},
       s:{de:"Das AI Office hat den finalen Verhaltenskodex zu den Kennzeichnungs- und Offenlegungspflichten nach Art. 50 KI-VO vorgelegt. Er besteht aus je einem eigenständig zeichenbaren Teil für Anbieter (maschinenlesbare Markierung, z. B. signierte Metadaten und Wasserzeichen) und für Betreiber (Offenlegung von Deepfakes und KI-generierten Texten zu Angelegenheiten von öffentlichem Interesse). Relevant für Institute, die generative KI etwa im Kundenkontakt einsetzen. Die Markierungspflicht nach Art. 50 Abs. 2 gilt nach dem KI-Omnibus ab 02.12.2026.",
          en:"The AI Office has presented the final code of practice on the labelling and disclosure duties under Art. 50 AI Act. It consists of separately signable parts for providers (machine-readable marking, e.g. signed metadata and watermarks) and for deployers (disclosure of deepfakes and AI-generated text on matters of public interest). Relevant for institutions using generative AI, for example in customer contact. Following the AI omnibus, the marking duty under Art. 50(2) applies from 2 December 2026."}},
      {d:"19.05.2026", deadline:"23.07.2026", t:{de:"Konsultation",en:"Consultation"}, src:"digital-strategy.ec.europa.eu",
       url:"https://digital-strategy.ec.europa.eu/en/library/draft-commission-guidelines-classification-high-risk-ai-systems",
       ti:{de:"Entwurf der Kommissionsleitlinien zur Einstufung von Hochrisiko-KI-Systemen (Art. 6 KI-VO)",en:"Draft Commission guidelines on the classification of high-risk AI systems (Art. 6 AI Act)"},
       s:{de:"Die Kommission konkretisiert nach Art. 6 Abs. 5 KI-VO mit Praxisbeispielen, wann ein KI-System als Hochrisiko-System gilt – sowohl als Sicherheitsbauteil regulierter Produkte (Anhang I) als auch in den Anwendungsfällen des Anhangs III, zu denen die Kreditwürdigkeitsprüfung natürlicher Personen und die Risikobewertung in der Lebens- und Krankenversicherung gehören. Die Konsultationsfrist wurde bis 23.07.2026 verlängert; die finalen Leitlinien sollen bis Ende 2026 folgen.",
          en:"Under Art. 6(5) AI Act, the Commission uses practical examples to specify when an AI system counts as high-risk – both as a safety component of regulated products (Annex I) and in the Annex III use cases, which include creditworthiness assessment of natural persons and risk assessment in life and health insurance. The consultation deadline was extended to 23 July 2026; final guidelines are expected by the end of 2026."}},
      ...
      {d:"18.07.2025", t:{de:"Leitlinien",en:"Guidelines"}, src:"digital-strategy.ec.europa.eu",
       ...
       ti:{de:"Leitlinien zum Umfang der Pflichten von Anbietern von KI-Modellen mit allgemeinem Verwendungszweck (GPAI)",en:"Guidelines on the scope of obligations for providers of general-purpose AI models (GPAI)"},
       s:{de:"Die Kommission erläutert, wann ein KI-Modell als GPAI-Modell gilt, wer als Anbieter gilt – auch bei nachträglicher Anpassung (Fine-Tuning) eines fremden Modells – und wann ein systemisches Risiko vorliegt. Für Institute ist damit die Rollenabgrenzung entscheidend: Wer ein Basismodell wesentlich weitertrainiert oder unter eigenem Namen bereitstellt, kann selbst zum Anbieter mit den Pflichten nach Art. 53 KI-VO werden, statt nur Betreiber zu sein. Als Nachweisinstrument dient Anbietern der GPAI-Verhaltenskodex vom 10.07.2025, den Kommission und KI-Gremium als angemessen bestätigt haben; er ist ein sinnvoller Prüfpunkt in der Due Diligence von Modellanbietern. Die GPAI-Pflichten gelten seit 02.08.2025.",
          en:"The Commission explains when an AI model is a GPAI model, who counts as a provider – including after modifying (fine-tuning) a third-party model – and when a systemic risk exists. For institutions the allocation of roles is decisive: anyone who substantially further trains a foundation model or makes it available under their own name may become a provider with the obligations of Art. 53 AI Act rather than merely a deployer. Providers can demonstrate compliance via the GPAI code of practice of 10 July 2025, confirmed as adequate by the Commission and the AI Board; it is a useful checkpoint in due diligence on model providers. The GPAI obligations have applied since 2 August 2025."}},
      {d:"06.02.2025", t:{de:"Leitlinien",en:"Guidelines"}, src:"digital-strategy.ec.europa.eu",
       ...
       ti:{de:"Leitlinien zur Definition des KI-Systems (Art. 3 Nr. 1 KI-VO)",en:"Guidelines on the definition of an AI system (Art. 3(1) AI Act)"},
       s:{de:"Die Kommission erläutert die Merkmale eines KI-Systems – insbesondere Autonomie, Anpassungsfähigkeit und Ableitung von Ausgaben aus Eingaben – und grenzt es von herkömmlicher Software und einfachen, regelbasierten Berechnungen ab. Maßgeblich für die Frage, welche Scoring- und Entscheidungsmodelle überhaupt unter die KI-VO fallen.",
          en:"The Commission explains the characteristics of an AI system – in particular autonomy, adaptiveness and inferring outputs from inputs – and distinguishes it from conventional software and simple rule-based calculations. Decisive for which scoring and decision models fall under the AI Act at all."}},
      {d:"04.02.2025", t:{de:"Leitlinien",en:"Guidelines"}, src:"digital-strategy.ec.europa.eu",
       ...
       ti:{de:"Leitlinien zu verbotenen KI-Praktiken (Art. 5 KI-VO)",en:"Guidelines on prohibited AI practices (Art. 5 AI Act)"},
       s:{de:"Die Kommission konkretisiert mit Beispielen die seit 02.02.2025 geltenden Verbote, u. a. manipulative Techniken, Ausnutzung von Schutzbedürftigkeit, Social Scoring und Emotionserkennung am Arbeitsplatz. Für Finanzunternehmen besonders relevant ist die Abgrenzung zulässiger Bonitäts- und Betrugsprüfungen vom verbotenen Social Scoring.",
          en:"With examples, the Commission specifies the prohibitions applicable since 2 February 2025, including manipulative techniques, exploitation of vulnerabilities, social scoring and emotion recognition in the workplace. Particularly relevant for financial firms is the line between permissible credit and fraud checks and prohibited social scoring."}},
      {refnum:"VO (EU) 2024/1689", eff:"02.08.2026", d:"12.07.2024", t:{de:"Verordnung",en:"Regulation"}, src:"eur-lex.europa.eu",
       ...
       s:{de:"Die Verordnung (EU) 2024/1689 gilt gestuft: verbotene Praktiken und KI-Kompetenz ab 02.02.2025, Pflichten für KI-Modelle mit allgemeinem Verwendungszweck ab 02.08.2025, allgemeiner Geltungsbeginn ab 02.08.2026. Die Hochrisiko-Pflichten (u. a. Kreditwürdigkeitsprüfung, Risikobewertung bei Lebens- und Krankenversicherungen) sollten ursprünglich ab 02.08.2026 bzw. 2027 gelten; der KI-Omnibus (VO (EU) 2026/1744) hat sie auf 02.12.2027 (Anhang III) bzw. 02.08.2028 (Anhang I) verschoben.",
          en:"Regulation (EU) 2024/1689 applies in stages: prohibited practices and AI literacy from 2 February 2025, obligations for general-purpose AI models from 2 August 2025, general application from 2 August 2026. The high-risk obligations (including creditworthiness assessment and risk assessment in life and health insurance) were originally due from 2 August 2026 or 2027; the AI omnibus (Regulation (EU) 2026/1744) postponed them to 2 December 2027 (Annex III) and 2 August 2028 (Annex I)."}}
    ]},
  ...
  { id:"consumer", jur:"EU+DE",
    ...
    u:[
      {eff:"20.11.2026", d:"17.04.2026", t:{de:"Gesetz",en:"Act"}, src:"bundestag.de",
       ...
       s:{de:"Das Gesetz überführt die CCD II in BGB, EGBGB und KWG: erweiterter Anwendungsbereich auf Kleinkredite und Buy-now-pay-later, verschärfte Kreditwürdigkeitsprüfung, neue Werbe- und Informationsvorgaben, das neue Aufsichtsregime für Absatzfinanzierer (AbsFinAG) sowie erstmals gesetzliche Regeln für Scoring und automatisierte Entscheidungen im Datenschutzrecht. Anwendung ab 20.11.2026.",
          en:"The act transposes CCD II into the BGB, EGBGB and KWG: extended scope covering small loans and buy-now-pay-later, stricter creditworthiness assessment, new advertising and information rules, the new supervisory regime for sales financiers (AbsFinAG) and, for the first time, statutory data protection rules on scoring and automated decisions. Applicable from 20 November 2026."}},
  ...
  { id:"ebaesg", jur:"EU",
    ...
    alias:"ESG-Risiken, ESG Risk Management, Transitionsplan, Transition Plan, Klimarisiken Banken, EBA/GL/2025/01, Nachhaltigkeitsrisiken Risikomanagement, ESG-Risikoplan, § 26c KWG, § 26d KWG, BRUBEG, Nachhaltigkeitsrisiken",
    ...
    u:[
      {d:"22.04.2026", t:{de:"Bericht",en:"Report"}, src:"bundesbank.de",
       url:"https://publikationen.bundesbank.de/publikationen-de/berichte-studien/monatsberichte/monatsbericht-april-2026-990912?article=nachhaltigkeitsrisiken-in-der-bankenaufsicht-973960",
       ti:{de:"Bundesbank-Monatsbericht: Nachhaltigkeitsrisiken in der Bankenaufsicht und aufsichtliche Erwartungen",en:"Bundesbank monthly report: sustainability risks in banking supervision and supervisory expectations"},
       s:{de:"Der Aufsatz im Monatsbericht April 2026 ordnet die Aufsichtserwartungen an das ESG-Risikomanagement ein: ESG-Risiken als Treiber von Kredit-, Markt- und operationellem Risiko in Risikoinventur, ICAAP, Stresstests und Strategie, ESG-Risikopläne nach dem BRUBEG, die EBA-Leitlinien EBA/GL/2025/01 mit Erstanwendung für kleine, nicht komplexe Institute am 11.01.2027 sowie die Säule-3-Offenlegung für alle Institute seit 2025. Eine Umfrage bei weniger bedeutenden Instituten zeigt Lücken bei Energieausweisen und bei der Bepreisung physischer Risiken.",
          en:"The article in the April 2026 monthly report sets out supervisory expectations for ESG risk management: ESG risks as drivers of credit, market and operational risk in the risk inventory, ICAAP, stress tests and strategy, ESG risk plans under the BRUBEG, the EBA guidelines EBA/GL/2025/01 with first application for small and non-complex institutions on 11 January 2027, and Pillar 3 disclosure for all institutions since 2025. A survey of less significant institutions reveals gaps in energy performance certificates and in pricing physical risks."}},
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"BRUBEG: ESG-Risikoplan nach § 26d KWG wird für deutsche Institute Pflicht",en:"BRUBEG: ESG risk plan under section 26d KWG becomes mandatory for German institutions"},
       s:{de:"Seit 31.03.2026 verankert das KWG ESG-Risiken im Risikomanagement (§ 26c KWG) und verlangt einen ESG-Risikoplan mit quantifizierbaren Zielen, Kennzahlen und Überwachungsverfahren über kurze, mittlere und lange Sicht von mindestens zehn Jahren (§ 26d KWG); Strategien und Prozesse sind mindestens alle zwei Jahre zu überprüfen, Geschäftsleiter müssen ESG-Kenntnisse mitbringen, Vergütungssysteme die ESG-Risikoneigung berücksichtigen. Kleine, nicht komplexe und vergleichbare Institute müssen den Plan erst ab 11.01.2027 aufstellen (§ 64c Abs. 3 KWG), dürfen Ziele rein qualitativ beschreiben und sich bis 31.12.2029 auf Umwelt- und Klimarisiken beschränken; die im Regierungsentwurf vorgesehene Anzeige des Plans an die BaFin strich der Bundestag, Förderbanken sind von ESG-Berichtspflichten ausgenommen.",
          en:"Since 31 March 2026 the KWG anchors ESG risks in risk management (section 26c KWG) and requires an ESG risk plan with quantifiable targets, metrics and monitoring procedures over short, medium and long horizons of at least ten years (section 26d KWG); strategies and processes must be reviewed at least every two years, managing directors need ESG expertise and remuneration systems must reflect the ESG risk appetite. Small and non-complex institutions and comparable ones only have to draw up the plan from 11 January 2027 (section 64c(3) KWG), may describe targets purely qualitatively and may limit themselves to environmental and climate risks until 31 December 2029; the Bundestag deleted the notification of the plan to BaFin foreseen in the government bill, and development banks are exempt from ESG reporting duties."}},
  ...
  { id:"fitproper", jur:"EU+DE",
    about:{de:"Eignungsanforderungen an Geschäftsleiter, Aufsichtsorgane und Inhaber von Schlüsselfunktionen: fachliche Qualifikation, Zuverlässigkeit, Zeitverfügbarkeit, kollektive Eignung und Diversität. Dazu Anzeige- und Prüfverfahren bei BaFin, Bundesbank und EZB. Seit dem BRUBEG (31.03.2026) gilt im KWG ein eigenes Eignungsregime für Inhaber von Schlüsselfunktionen (§ 25e KWG).",
           en:"Suitability requirements for management bodies, supervisory boards and key function holders: expertise, reputation, time commitment, collective suitability and diversity. Plus the notification and assessment procedures at BaFin, the Bundesbank and the ECB. Since the BRUBEG (31 March 2026) the KWG contains a separate suitability regime for key function holders (section 25e KWG)."},
    ...
    alias:"Fit and Proper, Fit & Proper, Eignungsprüfung, Geschäftsleiter, Aufsichtsrat, Verwaltungsrat, Schlüsselfunktionen, Schlüsselfunktionsinhaber, Key Function Holder, § 25e KWG, BRUBEG, EBA/GL/2021/06, Rundschreiben 11/2025, FAP-Anzeigen, Merkblatt Geschäftsleiter, Merkblatt Aufsichtsorgane, Inhaberkontrolle",
    ref:"EBA/GL/2021/06, §§ 25c–25e KWG, BaFin-Rundschreiben 11/2025", cond:null,
    ...
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 06.09.2026; BRUBEG-Verlauf gegen DIP, bundestag.de, recht.bund.de, bafin.de, bundesbank.de und gesetze-im-internet.de geprüft). */
    u:[
      {d:"04.09.2026", t:{de:"Mitteilung",en:"Statement"}, src:"bafin.de",
       url:"https://www.bafin.de/DE/unternehmen-maerkte/aufsicht/banken-institute/kreditinstitute/anzeige-meldepflichten/fap-anzeigen/fap-anzeigen_node.html",
       ti:{de:"BaFin: Anzeigen für Inhaber besonderer Schlüsselfunktionen, MVP-Portal ab dem 4. Quartal 2026",en:"BaFin: notifications for holders of special key functions, MVP portal from Q4 2026"},
       s:{de:"Die BaFin erläutert die Fit-&-Proper-Anzeigen nach dem BRUBEG: Ernennungen von Inhabern besonderer Schlüsselfunktionen sind nur anzuzeigen, wenn sie nach dem 31.03.2026 erfolgen. Von der EZB beaufsichtigte Institute nutzen das SSM-Portal, alle übrigen ab dem 4. Quartal 2026 das MVP-Portal der BaFin; bis dahin gelten die Formulare der Anzeigenverordnung.",
          en:"BaFin explains the fit-and-proper notifications under the BRUBEG: appointments of holders of special key functions need only be notified if they take place after 31 March 2026. Institutions supervised by the ECB use the SSM portal, all others BaFin's MVP portal from the fourth quarter of 2026; until then the forms of the notification ordinance apply."}},
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"BRUBEG in Kraft: Fit & Proper für Inhaber von Schlüsselfunktionen im KWG (§ 25e KWG)",en:"BRUBEG in force: fit and proper for key function holders in the KWG (section 25e KWG)"},
       s:{de:"Seit 31.03.2026 müssen Inhaber von Schlüsselfunktionen fachlich geeignet und zuverlässig sein (§ 25e KWG); die Leiter der internen Kontrollfunktionen und der Leiter Finanzen gelten als Inhaber besonderer Schlüsselfunktionen (§ 1 Abs. 2d KWG). Institute brauchen Verfahren zur Identifizierung und zur laufenden Eignungsprüfung, die Geschäftsleiter verantworten sie persönlich (§ 25c Abs. 4a Nr. 7 KWG). Große Unternehmen zeigen Ernennung und Abberufung der BaFin an (§ 24 Abs. 1 Nr. 15b, 16 KWG); die BaFin kann die Abberufung verlangen und Zwangsgelder unmittelbar gegen die Personen verhängen (§ 25e Abs. 3, § 50 KWG). Geschäftsleiter und Vorsitzende des Aufsichtsorgans großer Unternehmen sind spätestens 30 Arbeitstage vor Amtsübernahme anzuzeigen (§ 24 Abs. 1 Nr. 1 und 15 KWG); die Frist gilt für Anzeigepflichten, die ab 01.04.2026 entstehen (§ 64c Abs. 2 KWG).",
          en:"Since 31 March 2026 key function holders must be professionally qualified and reliable (section 25e KWG); the heads of the internal control functions and the head of finance count as holders of special key functions (section 1(2d) KWG). Institutions need procedures for identifying them and for ongoing suitability assessment, for which the managing directors are personally responsible (section 25c(4a) no. 7 KWG). Large undertakings notify BaFin of appointments and removals (section 24(1) nos. 15b, 16 KWG); BaFin may demand removal and impose periodic penalty payments directly on the persons concerned (sections 25e(3), 50 KWG). Managing directors and chairs of the supervisory body of large undertakings must be notified at least 30 working days before taking office (section 24(1) nos. 1 and 15 KWG); the deadline applies to notification duties arising from 1 April 2026 (section 64c(2) KWG)."}},
      ...
      {refnum:"Rundschreiben 11/2025 (BA)", d:"22.10.2025", eff:"01.01.2026", t:{de:"Rundschreiben",en:"Circular"}, src:"bafin.de",
       url:"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Rundschreiben/2025/rs_geschaeftsleiter_KWG_ZAG_KAGB.html",
       ti:{de:"BaFin-Rundschreiben 11/2025: neue Fit-&-Proper-Anforderungen an Geschäftsleiter und Aufsichtsorgane nach KWG",en:"BaFin circular 11/2025: new fit-and-proper requirements for managing directors and supervisory bodies under the KWG"},
       s:{de:"Das Rundschreiben ersetzt für den KWG-Bereich die Merkblätter vom 29.12.2020 zu Geschäftsleitern sowie zu Verwaltungs- und Aufsichtsorganen und setzt die EBA/ESMA-Leitlinien EBA/GL/2021/06 um: konkretisierte Sachkunde, zeitliche Verfügbarkeit auch in Krisen, strenge und einfache Mandatsobergrenzen, schriftliche Richtlinien zu Eignung, Diversität und Interessenkonflikten sowie Anzeigeverfahren und Formulare. Konsultiert seit 14.05.2025, für Prüfungszwecke seit 01.01.2026 zugrunde zu legen.",
          en:"For the KWG area the circular replaces the guidance notes of 29 December 2020 on managing directors and on members of administrative and supervisory bodies and implements the EBA/ESMA guidelines EBA/GL/2021/06: specified expertise, time commitment also in crises, strict and standard limits on mandates, written policies on suitability, diversity and conflicts of interest as well as notification procedures and forms. Consulted since 14 May 2025, to be applied for audit purposes since 1 January 2026."}},
      ...
      {d:"29.12.2020", eff:"01.01.2021", t:{de:"Merkblatt",en:"Guidance"}, src:"bafin.de",
       url:"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Merkblatt/mb_geschaeftsleiter_KWG_ZAG_KAGB.html",
       ti:{de:"BaFin überarbeitet Merkblätter zu Geschäftsleitern und Aufsichtsorganen",en:"BaFin revises guidance notes on managing directors and supervisory bodies"},
       s:{de:"Die Neufassungen der Merkblätter zu Geschäftsleitern (KWG, ZAG, KAGB) und zu Mitgliedern von Verwaltungs- und Aufsichtsorganen (KWG, KAGB) beschreiben Sachkunde, Zuverlässigkeit, zeitliche Verfügbarkeit und die Anzeigepflichten samt einzureichender Unterlagen. Für Prüfungszwecke galten sie ab 01.01.2021; im KWG-Bereich seit 01.01.2026 durch das Rundschreiben 11/2025 abgelöst.",
          en:"The recast guidance notes on managing directors (KWG, ZAG, KAGB) and on members of administrative and supervisory bodies (KWG, KAGB) describe expertise, reliability, time commitment and the notification duties including the documents to be submitted. They applied for audit purposes from 1 January 2021; in the KWG area they were replaced by circular 11/2025 from 1 January 2026."}},
  ...
  { id:"pfandbg", jur:"EU+DE",
    ...
    alias:"PfandBG, Pfandbrief, Pfandbriefgesetz, Covered Bond, Covered-Bond-Richtlinie, gedeckte Schuldverschreibungen, Deckungsregister, Deckungsregisterverordnung, DeckRegV, Beleihungswert, BRUBEG",
    ...
    /* Chronologie inkl. früherer Fassungen gegen EUR-Lex/Cellar, bafin.de, recht.bund.de bzw. eba.europa.eu geprüft (Stand 06.09.2026; BRUBEG-Artikel 23/24 gegen buzer.de und recht.bund.de geprüft). */
    u:[
      {refnum:"BGBl. 2026 I Nr. 81", d:"30.03.2026", eff:"31.03.2026", t:{de:"Gesetz",en:"Act"}, src:"recht.bund.de",
       url:"https://www.recht.bund.de/bgbl/1/2026/81/VO.html",
       ti:{de:"BRUBEG entlastet Pfandbriefbanken: keine halbjährliche Einreichung des Deckungsregisters mehr",en:"BRUBEG relieves Pfandbrief banks: no more half-yearly submission of the cover register"},
       s:{de:"Artikel 23 und 24 des Bankenrichtlinienumsetzungs- und Bürokratieentlastungsgesetzes streichen die Pflicht, Aufzeichnungen aller Eintragungen des Deckungsregisters halbjährlich in elektronischer Form bei der BaFin einzureichen und vom Treuhänder bestätigen zu lassen (§ 5 Abs. 2 PfandBG a. F.); die Bank muss nur noch sicherstellen, dass die Informationen zur Wiederherstellung des Registers sicher verwahrt sind. Teil 4 der Deckungsregisterverordnung (§§ 15 bis 17) entfällt, für bereits eingereichte Aufzeichnungen gelten die alten Regeln bis 31.03.2027. Die BaFin hatte die Einreichung mit Aufsichtsmitteilung vom 29.12.2025 bereits im Vorgriff ausgesetzt.",
          en:"Articles 23 and 24 of the Banking Directive Implementation and Bureaucracy Relief Act abolish the duty to submit records of all cover register entries to BaFin electronically every six months with the cover pool monitor's confirmation (former section 5(2) PfandBG); the bank now only has to ensure that the information needed to restore the register is kept safely. Part 4 of the Cover Register Ordinance (sections 15 to 17) is repealed, and the old rules continue to apply to records already submitted until 31 March 2027. By supervisory statement of 29 December 2025 BaFin had already suspended the submission in anticipation."}},
